...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 21, 2024 at 06:03 PM
...
CREATE TABLE `inventaris` (
  `inventaris_id` char(100) NOT NULL,
...
--
ALTER TABLE `inventaris`
  ADD CONSTRAINT `inventaris_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `item` (`item_id`),
  ADD CONSTRAINT `inventaris_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
  ADD CONSTRAINT `inventaris_ibfk_3` FOREIGN KEY (`tanaman_id`) REFERENCES `tanaman` (`tanaman_id`);
...
ALTER TABLE `tanaman`
  ...
  ADD CONSTRAINT `tanaman_ibfk_2` FOREIGN KEY (`inventaris_id`) REFERENCES `inventaris` (`inventaris_id`);
